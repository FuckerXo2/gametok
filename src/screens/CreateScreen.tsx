...
const GENRE_CHIPS = [
  { 
    ...
    label: 'Platformer', 
    prompts: [
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Intense 2D Platformer\n- Player: A nimble blue ninja (represented as a rectangle with a trail).\n- Mechanics: Arrow keys to move, Space/Tap to jump. Allow double jumps. Wall sliding and wall jumping mechanics enabled.\n- Level: A tall, vertical climbing layout with static platforms and moving horizontal platforms.\n- Obstacles: Red spinning saw blades that patrol back and forth. Hitting one resets the game.\n- Collectibles: Glowing yellow coins scattered in hard-to-reach places. Collecting one adds 10 to score.\n- Visuals: Dark cyberpunk city vibe, neon-colored elements, dark background.\n- UI: Show exact Score at the top-left.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Precision Single-Screen Platformer\n- Player: A green slime block.\n- Mechanics: Hold and release to fling the slime like a slingshot (Angry Birds style) to bounce off walls.\n- Level: An enclosed dungeon room full of static spike traps on random walls.\n- Goal: Reach a glowing blue portal at the end of the room without touching the spikes to advance to the next procedurally generated room.\n- Gravity: Normal downward gravity affects the slime while in the air.\n- Visuals: Retro arcade dungeon style, simple colored boxes. Screen shake on wall impacts.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Auto-Runner Platformer\n- Player: Constant forward-moving neon pink rectangle.\n- Mechanics: Tap screen to jump over bottomless pits.\n- Level Design: Infinite procedural generation of floating platforms of varying widths and gaps.\n- Game Loop: The speed of the player slowly increases every 10 seconds to increase difficulty.\n- Visuals: Synthwave grid floor that scrolls backward to simulate 3D motion, deep purple background, lots of glow effects.\n- UI: Distance traveled in meters at the top center.'
    ] 
  },
  { 
    ...
    label: 'Puzzle', 
    prompts: [
      'Create a complete, fully playable HTML5 physics game using Canvas 2D and Matter.js.\n\nType: Drawing Physics Puzzle\n- Objective: Guide a fragile falling circle (the egg) into a static green box (the basket) at the bottom.\n- Mechanics: Player clicks and drags across the screen to draw solid, static line segments. \n- Level: The egg starts falling from the top. Obstacles exist in the middle.\n- Particles: If the egg hits an obstacle too hard, it shatters into particles and the level restarts.\n- Visuals: Soft pastel colors, sketchbook aesthetic. Lines look like ink.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Match-3 Chain Puzzle\n- Grid: 8x8 grid of colored gems (red, blue, green, yellow, purple).\n- Mechanics: Click on two adjacent gems to swap them. If a line of 3 or more is formed, destroy them, add points, and drop gems from above to fill gaps.\n- Cascades: Allow chain reactions if falling gems make new matches.\n- Visuals: Juicy juice! Massive particle explosions when gems pop, satisfying screen shake on large chains, numbers floating up.\n- UI: Score counter and moves left counter.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Physics Stacking Puzzle\n- Mechanics: A crane sways back and forth at the top of the screen holding a random polyominio block (Tetris shape). Tap the screen to drop it.\n- Physics: Blocks use realistic 2D rigid body physics to stack on a central platform.\n- Objective: Stack tower as high as possible without any blocks falling off the screen.\n- Visuals: Construction site aesthetic, blocks are different neon colors. Dynamic camera zoom out as the tower grows.\n- UI: Current height score shown boldly.'
    ] 
  },
  { 
    icon: 'rocket', 
    ...
    label: 'Space', 
    prompts: [
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Vertical Space Shooter\n- Player: A spaceship at the bottom, moves by dragging left/right. Auto-fires blue lasers forward constantly.\n- Enemies: Waves of red alien ships fly down from top, shooting slow red bullets.\n- Mechanics: Player laser destroys enemies (10 pts). Enemy bullets or ship collision destroys player.\n- Power-ups: Destroying an alien has a 10% chance to drop a yellow capsule. Catching it upgrades lasers to triple-spread.\n- Background: Infinite scrolling starfield parallax (2 layers of stars at different speeds).\n- UI: Glowing score and lives counter.',
      'Create a complete, fully playable HTML5 Canvas 2D game using Arcade Physics.\n\nType: Lunar Lander Physics Simulator\n- Player: A lander module affected by constant downward gravity.\n- Controls: Hold Left/Right screen halves to activate angled thrusters, generating upward and horizontal thrust. \n- Objective: Land smoothly (velocity under threshold) on randomly generated flat landing pads on a jagged crater terrain.\n- Fuel: Thruster usage drains limited fuel. Landing re-fuels and generates the next level.\n- Visuals: Retro vector graphics, wireframe green lines on a black canvas. Fire particles when thrusting.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Endless Asteroid Dodger\n- Player: A rocket fixed at the center-bottom. Steers by horizontal swiping.\n- Obstacles: Hundreds of gray rocky asteroids fall from the top at varying speeds and sizes.\n- Progression: The spawn rate and fall speed increase continuously.\n- Power-ups: Blue shields grant 1-hit invincibility. Yellow speed boosts slow down time momentarily.\n- Visuals: Epic nebula background with depth, asteroids smoothly rotate as they fall.\n- UI: Score based on time survived.'
    ] 
  },
  { 
    icon: 'flash', 
    ...
    label: 'Battle', 
    prompts: [
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Top-Down Twin Stick Shooter Survival\n- Player: A wizard in the center of the screen. Move with WASD, fire magic bolts by clicking toward the mouse.\n- Enemies: Endless hordes of stupid zombies spawn from the screen edges and slowly path towards the player.\n- Mechanics: Magic bolts destroy zombies (1 hit). Player dies in 3 hits.\n- Upgrades: Every 20 zombies killed triggers a level up menu to choose a buff: Faster Fire Rate, Piercing Bolts, or Move Speed.\n- Visuals: Dark graveyard map, glowing magical projectiles, blood splatters on the ground.\n- UI: Experience bar at the bottom.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Turn-based RPG Battle\n- Setup: Player hero on left, Giant dragon boss on right.\n- Mechanics: Simple menu appears -> Attack, Defend, Heal, Magic.\n- Flow: Player selects action -> Animation plays -> Boss randomly selects attack/defend -> Animation plays. Turn repeats.\n- Logic: Boss has 1000 HP, Player has 100 HP. Player Magic costs MP and does heavy damage. Heal restores HP.\n- Visuals: Classic JRPG 16-bit style, side view. Floating damage numbers on hits. Screen shake on heavy attacks.\n- UI: Health bars updating smoothly.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Auto-Battler Simulator\n- Grid: The screen is a green battlefield. Player clicks left side to spawn allied Knights. Right side constantly spawns Enemy Orcs.\n- AI Mechanics: All units automatically identify the closest enemy and move towards them to engage in melee combat until one dies.\n- Logic: Knights have more HP, Orcs attack faster. Allow the player to spawn up to 50 knights to watch massive battles unfold.\n- Visuals: Simple color geometry (Blue circles for Knights, Red for Orcs). Little swords clash when fighting. Heavy juice.'
    ] 
  },
  { 
    icon: 'basketball', 
    ...
    label: 'Sports', 
    prompts: [
      'Create a complete, fully playable HTML5 Canvas 2D string physics game.\n\nType: Drag-to-shoot Basketball\n- Mechanics: Player clicks and drags backward from a basketball to aim it, showing a dotted trajectory line. Release to shoot.\n- Physics: Realistically bounce the ball off the rim and backboard.\n- Objective: Score a basket. When scored, move the hoop to a random new location and increase the score by 2.\n- Visuals: Minimalist street court at night, glowing neon hoop.\n- UI: Score at the top, streak counter with fire particles for 3+ streaks.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Top-Down Soccer\n- Player: Blue circle (you), WASD to move. \n- Ball: White circle in the center. Pushed smoothly when collided with.\n- Enemies: Red circles (AI) that always move towards the ball to push it into your net.\n- Mechanics: Player can press Space to dash tackle the ball, launching it at high speed.\n- Goal: Score 5 goals in the top red net.\n- Visuals: Bright green pitch with white lines. Fun celebratory fireworks when a goal is scored.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Neon Air Hockey\n- Controls: Player drags a blue mallet around their half of the table.\n- Enemy: Red mallet AI that follows the puck\'s X axis on the top half.\n- Physics: Puck bounces off walls with zero friction but slight dampening. Speed increases after every bounce.\n- Scoring: Puck goes into opponent\'s goal, score +1. First to 7 wins.\n- Visuals: Glow-in-the-dark arcade air hockey table. Puck leaves a cyan trail.'
    ] 
  },
  { 
    icon: 'skull', 
    ...
    label: 'Survival', 
    prompts: [
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Base Defense Survival\n- Core Loop: Player is a turret in the center. During DAY, you generate scrap automatically. During NIGHT, enemies spawn from all screen edges.\n- Mechanics: Use scrap to buy walls or upgrade turret damage/fire rate by clicking buttons around the base.\n- Enemy AI: Enemies stop to attack walls. If walls break, they attack you.\n- Day/Night Cycle: Background slowly fades from light blue to dark purple.\n- UI: Current Day counter, Scrap count, Health Bar.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Vampire Survivors Clone\n- Player: Moves towards the mouse constantly. Automatically fires a rotating fan of knives every 1 second.\n- Enemies: Hundreds of slow-moving bats constantly swarm the player from outside the screen.\n- Experience: Dead bats drop green gems. Player runs over gems to level up.\n- Upgrades: Levelling up pauses the game and offers a choice between: +1 Knife, +Knife Speed, +Player Speed.\n- Visuals: Gothic pixel art style, massive swarms of enemies without lagging.',
      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Oxygen Mining Survival\n- Player: Astronaut on an alien planet surface. Moves with arrow keys.\n- Mechanics: A massive Oxygen bar at the top depletes steadily. You must mine blue crystals (stand next to them for 2 seconds) and return them to the base station to replenish oxygen.\n- Threats: Random solar flares (screen turns red, must hide in base or take rapid damage) and slow moving sand-worms.\n- Visuals: Mars-like orange terrain, particle dust storms.'
    ] 
  }
];
            ...
            <View style={styles.inputCard}>
              ...
              <View style={styles.inputBottomRow}>
                <Pressable
                  ...
                  onPress={() => {
                    const surprises = [
                      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Infinite Gravity Runner\n- Player: A bright cyan neon square.\n- Mechanics: Tapping the screen instantly flips gravity, making the player fall completely to the ceiling or floor.\n- Obstacles: Red neon spikes spawn randomly on the floor and ceiling. The player must flip gravity to avoid them. Move the obstacles toward the player from right to left continuously.\n- Visuals: Dark synthwave aesthetic. Background is deep purple. Trail of blue particles follows the player.\n- Logic: When player hits a spike, restart the scene immediately to score 0.',
                      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Tower Defense\n- Mechanics: A road zig-zags from the left to the right side of the screen. Player clicks to build auto-firing turrets alongside the track using Money.\n- Enemies: Endless waves of zombie circles spawn left and walk the track. HP increases per wave.\n- Turrets: Shoot closest enemy. Upgradable damage.\n- Logic: If zombie reaches the end, lose 1 life. Start with 10 lives. Zombies drop money on death.\n- UI: Wave number, Money, Lives displayed clearly.',
                      'Create a complete, fully playable HTML5 HTML/JS game.\n\nType: Drawing Slicer Game\n- Mechanics: Fruits (circles/rectangles) are continuously shot upwards from the bottom of the screen with physics.\n- Controls: Player clicks and drags the mouse quickly to draw a "slice" line across the screen.\n- Logic: Intersecting a fruit with a slice line destroys it, adding to score. If a fruit falls back down unsliced, lose a life.\n- Bombs: Occasionally a black bomb is tossed up; slicing it loses the game immediately.\n- Visuals: Juice splatters everywhere upon slicing.',
                      'Create a complete, fully playable HTML5 Canvas 2D game.\n\nType: Physics Office Chaos\n- Player: A stick figure in the center holding a stapler.\n- Controls: Click and drag back (like a slingshot) on the player, then release to launch the stapler with high trajectory physics.\n- Enemies: Zombie coworkers slowly march toward you from both sides.\n- Logic: The thrown stapler must physically hit the zombies to knock them over using rigid body ragdoll physics. Zombies die if hit hard enough. Staplers bounce off walls.\n- Visuals: Office cubicle background, funny cartoon styling.'
                    ];
