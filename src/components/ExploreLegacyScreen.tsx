...
interface ExploreLegacyScreenProps {
  showHeader?: boolean;
}

export const ExploreLegacyScreen: React.FC<ExploreLegacyScreenProps> = ({ showHeader = true }) => {
...
export default ExploreLegacyScreen;
